...
function Header() {
  ...
  return (
    <div>
      <header>
        <nav class="bg-white border-gray-50 px-4 lg:px-6 py-2.5 dark:bg-white-400 shadow-sm: Small shadow  ">
          <div class=" z-20 flex  justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div
              class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 bg:white-400"
              id="mobile-menu-2"
            >
              <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0"></ul>
              <img
                class="w-10 h-10 rounded-full ml-315"
